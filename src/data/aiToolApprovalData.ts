...
const records: AiToolApprovalRecord[] = [
  ...
  ...([
    ...
    ["chatGPT Business Plan Standard", "mjlee0828@riskzero.kr", "이민재 부장 / 플랫폼개발", "플랫폼개발", 25, 37125],
    ["chatGPT Business Plan Standard", "dhlee@riskzero.kr", "이동훈 부장 / 플랫폼개발", "플랫폼개발", 25, 37125],
    ["chatGPT Business Plan Standard", "huizhen0227@riskzero.kr", "김혜진 과장 / 플랫폼개발", "플랫폼개발", 25, 37125],
    ["chatGPT Business Plan Premium", "mjkim1122@riskzero.kr", "김민정 차장 / 플랫폼개발", "플랫폼개발", 125, 185625],
    ["chatGPT Business Plan Premium", "sieghaft@riskzero.kr", "김성진 부장 / 플랫폼개발", "플랫폼개발", 125, 185625],
    ["chatGPT Business Plan Premium", "mygu@riskzero.kr", "구문영 사원 / 플랫폼개발", "플랫폼개발", 125, 185625],
    ["chatGPT Business Plan Standard", "staycurious@riskzero.kr", "김하나 과장 / 플랫폼개발", "플랫폼개발", 25, 37125],
    ["chatGPT Business Plan Premium", "ykchj1011@riskzero.kr", "윤영관 과장 / 플랫폼개발", "플랫폼개발", 125, 185625],
    ["chatGPT Business Plan Standard", "crow326@riskzero.kr", "박정원 차장 / 플랫폼개발", "플랫폼개발", 25, 37125],
    ["chatGPT Business Plan Standard", "sjpark@riskzero.kr", "박수진 과장 / 플랫폼개발", "플랫폼개발", 25, 37125],
  ...
  })),
  {
    ...
    account: "airyoubi77@riskzero.kr",
    owner: "조욱상 이사 / 경영혁신팀",
    department: "경영혁신팀",
    monthlyUsd: 125,
    monthlyKrw: 185625,
  ...
  },
  {
    ...
    monthlyKrw: 37125,
    priceHistory: [
      { effectiveMonth: "2026-01", monthlyUsd: 25, monthlyKrw: 37125 },
      { effectiveMonth: "2026-08", monthlyUsd: 125, monthlyKrw: 185625 },
      { effectiveMonth: "2026-09", monthlyUsd: 25, monthlyKrw: 37125 },
    ],
    paymentMethod: "AI 전용 카드",
    note: "",
  },
  ...
  ...[
    ["Claude Team Plan Standard", "jyjo@riskzero.kr", "조주연 부장 / 전략사업팀", "전략사업팀", 25, 37125],
    ...
    ["Claude Team Plan Standard", "cslee@riskzero.kr", "이창섭 부장 / 플랫폼개발", "플랫폼개발", 25, 37125],
...
export const initialAiToolApprovalData: AiToolApprovalData = {
  ...
  insights: [
    ...
    "변경 반영: 2026년 9월 17일 Claude 회원 명단 기준으로 김영산 과장의 Claude Team Plan을 9월부터 Standard로 정정하고 김기환 대리의 Standard 좌석을 추가했습니다.",
    ...
    "변경 반영: 박정원 차장과 박수진 과장에게 ChatGPT Business Plan Standard를 반영하고, 박수진 과장의 Claude 좌석은 교체 제거했습니다.",
    "변경 반영: 윤영관 과장의 ChatGPT Business 좌석을 Standard에서 Premium으로 변경했습니다.",
    "변경 반영: 구문영 사원의 ChatGPT Business 좌석을 Standard에서 Premium으로 변경했습니다.",
    "변경 반영: 2026년 9월부터 김민정 차장의 ChatGPT Business 좌석을 Premium으로 변경하고 김성진 부장에게 Premium 좌석을 추가했습니다.",
    "변경 반영: 김성진 부장의 Claude Team Plan을 2026년 9월부터 Standard에서 Premium으로 변경했습니다.",
    "변경 반영: 윤영관 과장의 Claude Team Plan을 2026년 9월부터 Standard에서 Premium으로 변경했습니다.",
