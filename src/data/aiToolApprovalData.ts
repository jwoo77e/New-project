...
export const initialAiToolApprovalData: AiToolApprovalData = {
  source: {
    ...
    note: "계정 ID, 주사용자/부서, 구독료, 결재수단과 적용 시작월을 반영했으며 AI 도구 사용 직원 38명 Claude Team Plan, ChatGPT Business Premium·Standard와 플랫폼개발팀 GH AI Agent 개발용 AI API 서비스 고정비 150만원을 포함",
  },
  exchangeRate,
  ...
  insights: [
    ...
    "변경 반영: 김영산 과장의 Claude Team Plan을 2026년 8월부터 Standard에서 Premium으로 변경했습니다.",
