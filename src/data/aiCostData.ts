...
export const initialDashboardData: DashboardData = {
  ...
  monthlyActuals: [
    ...
    { month: "2026-08", label: "8월", amount: 7349650, transactions: 44 },
  ],
  forecastAdjustments: [
    {
      month: "2026-01",
  ...
  categoryCosts: [
    { name: "Claude/Anthropic", amount: 14175862, color: "#5f6f8c" },
    { name: "Google/Gemini", amount: 13736142, color: "#0f8b8d" },
    { name: "ChatGPT/OpenAI", amount: 8523522, color: "#c58612" },
    { name: "Genspark", amount: 6864283, color: "#e85d4f" },
    { name: "미분류", amount: 551305, color: "#7a8580" },
    { name: "Gamma", amount: 376477, color: "#2f8f46" },
    { name: "Perplexity", amount: 33126, color: "#7f5aa2" },
    { name: "Ollama", amount: 31682, color: "#42a6a8" },
  ],
  vendorCosts: [
    { name: "Anthropic PBC", amount: 11603654 },
    { name: "MAINFUNC PTE. LTD.", amount: 6673229 },
    { name: "토스페이먼츠", amount: 5577335 },
    { name: "OpenAI ChatGPT Subscription", amount: 5302054 },
    { name: "구글클라우드코리아_TOSS", amount: 5176160 },
