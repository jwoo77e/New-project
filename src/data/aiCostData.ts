...
export const initialDashboardData: DashboardData = {
  sourceMeta: {
    fileName: "AI 관련 비용 분석_부서별_대시보드용.xlsx + 2026년 4-5월 법인카드 AI 사용내역",
    sourceSheet: "키워드검색결과 + 2026년 전체내역 + 2026년 5월",
    period: "2026년 1월 - 5월",
    recordCount: 99,
    totalActual: 27842183,
  ...
  departmentCosts: [
    ...
    },
    {
      ...
      transactions: 15,
      total: 687586,
      monthly: { "2026-01": 74623, "2026-02": 186560, "2026-03": 172668, "2026-04": 253735, "2026-05": 0 },
    },
    {
      name: "플랫폼개발팀(단독)",
      sourceName: "박재현",
      ...
      transactions: 3,
      total: 87000,
      monthly: { "2026-01": 29000, "2026-02": 29000, "2026-03": 0, "2026-04": 29000, "2026-05": 0 },
    },
    {
      name: "경영혁신팀(단독)",
      sourceName: "조욱상",
      ...
      transactions: 6,
      total: 201515,
      monthly: { "2026-01": 0, "2026-02": 0, "2026-03": 51958, "2026-04": 149557, "2026-05": 0 },
    },
    {
      name: "기술연구소(단독)",
      ...
      transactions: 5,
      total: 850913,
      monthly: { "2026-01": 0, "2026-02": 0, "2026-03": 0, "2026-04": 0, "2026-05": 850913 },
    },
    {
      name: "스마트서비스팀(단독)",
      sourceName: "-",
      ...
      transactions: 0,
      total: 0,
      monthly: { "2026-01": 0, "2026-02": 0, "2026-03": 0, "2026-04": 0, "2026-05": 0 },
    },
    {
      name: "전략사업팀(단독)",
      sourceName: "-",
  ...
  categoryCosts: [
    ...
    { name: "ChatGPT/OpenAI", amount: 4747848, color: "#c58612" },
    { name: "Genspark", amount: 4354162, color: "#e85d4f" },
    { name: "Claude/Anthropic", amount: 4211121, color: "#5f6f8c" },
    { name: "미분류", amount: 514120, color: "#7a8580" },
    { name: "Gamma", amount: 263982, color: "#2f8f46" },
  ...
  vendorCosts: [
    ...
    { name: "MAINFUNC PTE. LTD.", amount: 4163108 },
    { name: "구글클라우드코리아", amount: 2240512 },
    { name: "Anthropic PBC", amount: 2155019 },
    { name: "OPENAI OPCO", amount: 1966351 },
    { name: "Claude.ai Subscription", amount: 1868602 },
    { name: "OpenAI ChatGPT Subscription", amount: 1681362 },
