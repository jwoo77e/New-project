...
const jaewooZipModifiedAt = "2026-06-28T23:30:57.725Z";
...
const hyungbaeDateFolderUrl = "https://drive.google.com/drive/folders/1Stpkhtncku7m-bRDwRXXNJBcIcnWpgq8?usp=sharing";
const hyungbaeDocsCreatedAt = "2026-06-28T18:10:10.103Z";
const hyungbaeDocsModifiedAt = "2026-06-28T18:16:08.280Z";
...
const hyungbaeArtifacts: DriveArtifact[] = [
  hyungbaeDoc(
    "2026-06-29 / Collect data from all station resource pages (b6a9200d)",
    "1AxUcqpeyciV1qdDR3NrblikrnFksdZqwea9bGMKhhOc",
    "자료실·현장 데이터 수집",
    "GH Biz&고양 23개 현장 자료실을 점검하고 양주은남 현장 파일 3건을 확보한 세션",
  ),
  hyungbaeDoc(
    "2026-06-29 / Document TBM safety management system (0b3672ce)",
    "1-5fdqoIIJQc7bprHNdEXWkVq5s1z5QdBqjfXgEmzyyI",
    "현장 안전관리 자료",
    "4개 활성 현장의 TBM 263건과 첨부 메타데이터 823건을 정리하고 자동 다운로드 제한을 기록",
  ),
  hyungbaeDoc(
    "2026-06-29 / Document safety management system pages (c921fcc7)",
    "1yMMatFLVnu47WAUEcAj33UKC8xD6HQwvalc4MiZxsg0",
    "현장 안전관리 자료",
    "노사협의체 자료 23개 현장 점검, 6개 현장 18개 회의 기록과 첨부 파일 수집 결과",
  ),
  hyungbaeDoc(
    "2026-06-29 / Collect ergonomic hazard assessment data (6e85c136)",
    "1KB_AV0UMykBOaVcOLCX4_zwMoDvNYkIMwzuwzheSi4w",
    "현장 안전관리 자료",
    "근골격계 유해요인조사 23개 현장 점검, 용인 2공구 조사 2건과 PDF 3건 수집",
  ),
  hyungbaeDoc(
    "2026-06-29 / Collect safety management plan data (7a5e7017)",
    "1To5QMtXLxkMz83leJ3iS8IWIqcTE9xC_gbgP4WowS5o",
    "안전관리 계획·비용",
    "부서별 안전보건관리계획 23개 현장을 확인했으나 수집 가능한 기록이 없음을 검증",
  ),
  hyungbaeDoc(
    "2026-06-29 / Collect safety management cost data (6348cd75)",
    "14Uxg38Tp7zLwd-djQGVT4qFbutJ-IITO4VktsJHUOMk",
    "안전관리 계획·비용",
    "산안법 안전관리비 계획 탭에서 약 1.9조원 대상액과 약 520억원 계상액, 첨부 21건을 정리",
  ),
  hyungbaeDoc("2026-06-29 / V2 safety management cost branch (f959b650)", "1d68IkizXpn6T5YWfESfMWWjOnmpfu0kb5ETgyG0_BP0", "안전관리 계획·비용", "안전관리비 수집 세션의 보완본으로 대상 현장 조회와 다운로드 준비 흐름을 보존"),
  hyungbaeDoc("2026-06-29 / V2 safety management pages branch (a99fe24b)", "1svf74s7JJeBUOajKnaR0TSjorNSJLMPjwYeRxWlAuBo", "현장 안전관리 자료", "안전관리 시스템 페이지 문서화 세션의 보완본으로 현장별 페이지 탐색을 보존"),
  hyungbaeDoc("2026-06-29 / Document safety equipment distribution across sites (718b84a0)", "136cAHgWHoBcx_GG2as9MxKGBEj3n65jGk855KpOl9eI", "현장 안전관리 자료", "현장별 안전장비 배치·배포 현황을 문서화한 세션"),
  hyungbaeDoc("2026-06-29 / Collect safety facility data across sites (59f4398d)", "1ZhwK9qVEDuFE74IDMJABufgkuDwDEE72YLjeg-a8hrA", "현장 안전관리 자료", "현장별 안전시설 데이터를 수집하고 비교하기 위한 세션"),
  hyungbaeDoc("2026-06-29 / Collect risk assessment data from all sites (2c77ed42)", "1GM5X9oqsBlWWG-ytCB1G8kcV24fdt9vnGkR79ss7VW8", "현장 안전관리 자료", "전체 현장 위험성평가 자료를 수집·검증한 세션"),
  hyungbaeDoc("2026-06-29 / Collect disaster response manuals from all sites (4d18ed3c)", "1EwGF-crAaCOG6JWkw5RF9PUDr-WL8e_avVo8XgjU8Bg", "현장 안전관리 자료", "전체 현장 재난대응 매뉴얼 자료 수집을 수행한 세션"),
  hyungbaeDoc("2026-06-29 / Document safety report system across sites (ab9618f4)", "1Flo8CfC_oIVwMhJg0-gWr3NoWcLxlMxlNkgY1LQx4eg", "현장 안전관리 자료", "현장별 안전보고 체계와 보고 흐름을 문서화한 세션"),
  hyungbaeDoc("2026-06-29 / Collect safety management cost data (05ac25e6)", "1kX6UugfKBHL-oRyZV-LavmWsazSx-E6i9ju_oiudRng", "안전관리 계획·비용", "임시소방시설비 또는 안전관리비 관련 수집 결과를 정리한 세션"),
  hyungbaeDoc("2026-06-29 / Collect safety management expense data (5915ecf8)", "1iOqc01m0HjhHkC9vy28fsMGKs1QzbUOY-UbXhELCq1M", "안전관리 계획·비용", "안전관리비 집행·경비 자료 수집 결과를 정리한 세션"),
  hyungbaeDoc("2026-06-29 / Collect risk assessment data from all sites (bad3d43a)", "1yZrlsD65VmIRpnxrKwcKXGPOutW8g6pGu9xxi8Ygll8", "현장 안전관리 자료", "전체 현장 위험성평가 자료를 수집·검증한 별도 세션"),
];
...
const zipAnalysisPipeline: DriveZipAnalysisPipeline = {
  collectedAt: "2026-06-29 23:08 KST",
  ...
  stages: [
    {
      ...
      result: "김재우 폴더에서 기존 6/23~6/28 split zip 계열과 최신 AX_2026-06-29_백업.zip.part00~part11 12개를 확인. 이형배 폴더는 claude-backup-2026-06-29 날짜별 Docs 폴더로 갱신",
    },
    {
      label: "2. 임시 결합",
      action: "part 번호 순서대로 /private/tmp 영역에서 단일 zip으로 결합",
      result: "최신 6/29 백업은 part00~part11 순서가 완성됐고 총 6,986 bytes를 /private/tmp에서 결합한 뒤 zip 테스트와 해제를 수행",
    },
    {
      label: "3. 압축 해제 분석",
      action: "프롬프트·응답·SKILL·엑셀 산출물의 파일명, 크기, 본문 요약을 추출",
      result: "6/29 zip 내부에서 6개 파일, 2개 작업 묶음, 프롬프트 2개와 응답 2개를 확인. Ops_dashboard_tab2_3h 프롬프트 1개는 unzip 테스트에서 CRC 경고가 발생",
    },
    {
      label: "4. 임시 파일 삭제",
      action: "분석 후 결합 zip과 해제 폴더를 제거하고 요약 결과만 대시보드 데이터로 유지",
      result: "Drive 원본은 변경하지 않았고, connector base64로 만든 part 파일·결합 zip·해제 폴더가 있던 /private/tmp/drive-zip-20260629.* 임시 디렉터리는 삭제됨",
    },
  ],
  totals: {
    splitParts: 46,
...
const repositories: DriveArtifactRepository[] = [
  buildRepository({
    ...
    insights: [
      "Drive 폴더에는 최신 AX_2026-06-29_백업.zip.part00~part11 12개와 6/29 AX Docs·처리로그가 추가됐습니다.",
      "6/29 백업 zip은 connector raw base64 payload로 /private/tmp에서 결합·unzip 검증했고, 내부 6개 파일·2개 작업 묶음을 확인했습니다.",
      "Ops_dashboard_tab2_3h_6fb565c4b3a1 프롬프트 파일은 CRC 경고가 있어 원문 재검증 대상으로 표시합니다.",
    ],
  }),
  buildRepository({
    owner: "이형배",
    ...
    insights: [
      "최신 하위 폴더 claude-backup-2026-06-29에서 31개 Google Docs와 SKILL 파일 2개를 확인했고, 의미 있는 현장·안전관리 Docs 16개를 선별했습니다.",
...
export const driveArtifactRepositoryData: DriveArtifactRepositoryData = {
  source: {
    ...
    collectedAt: "2026-06-29 23:08 KST",
    period: "2026-06-21 ~ 2026-06-29",
    note: "김재우 폴더는 최신 AX_2026-06-29_백업.zip.part00~part11과 6/29 AX Docs·처리로그를 확인했고, 이형배 폴더는 claude-backup-2026-06-29 날짜 폴더 아래 31개 Docs와 2개 SKILL 파일 중 현장·안전관리 분석에 직접 쓰이는 16개를 선별했습니다.",
  },
  totals: {
  ...
  insights: [
    ...
    "최신 김재우 6/29 분할 zip은 로컬 임시 디렉터리에서 결합·해제 검증을 완료했고, CRC 경고 1건을 별도 재검증 이슈로 남겼습니다.",
  ],
};
