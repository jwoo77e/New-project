...
export const initialClaudeTeamUsageData: ClaudeTeamUsageData = {
  source: {
    ...
    period: "Members 2026-07-20 · Active 관리자 확인 2026-08-05 · Spend 2026-08-01~03 · Lines 2026-08 누적",
    ...
    note: "Claude 멤버 목록(7월 20일), Spend report(8월 1-3일), Claude Code lines 8월 누적 export를 email 기준으로 결합하고 결재 등록 Team 계정 20개와 대조했습니다. 활성 인원은 8월 5일 관리자 확인값을 적용했습니다.",
    verification: {
      spendRecords: 43,
      codeLineAccounts: 15,
      matchedAccounts: 13,
      approvedAccounts: 20,
      memberAccounts: 20,
      activeMemberAccounts: 20,
      rawOnlyAccounts: 0,
      approvedButNoUsage: 4,
      note: "결재 등록 20개 계정은 8월 5일 관리자 확인 기준 모두 Active입니다. 8월 Team CSV에서는 16개 계정의 사용 신호가 확인되며, 박재현 상무는 Export 대화 1건이 있으나 이번 Spend/Code Lines CSV에는 없습니다.",
    },
  },
  licensedUsers: 20,
  activeUsers: 20,
  ...
  insights: [
    "결재 등록 Claude Team 좌석 20개는 8월 5일 관리자 확인 기준 모두 Active이며 활성률은 100%입니다.",
