...
export const initialClaudeTeamUsageData: ClaudeTeamUsageData = {
  source: {
    ...
    note: "Claude Spend report(7월 1-12일)와 Claude Code lines export(7월 1-31일)를 user email 기준으로 결합하고, AI 도구 결재 현황의 Team 계정 19개와 대조",
    verification: {
      spendRecords: 88,
      codeLineAccounts: 16,
      matchedAccounts: 16,
      approvedAccounts: 19,
      rawOnlyAccounts: 0,
      approvedButInactive: 2,
      note: "Spend 17개 계정과 Code Lines 16개 계정 중 16개가 교차 확인되었습니다. 원천 확인 계정은 모두 결재 등록되었고, 7월 미활성 결재 계정 2개는 별도 확인이 필요합니다.",
    },
  },
  licensedUsers: 19,
  activeUsers: 17,
  ...
  insights: [
    ...
    "결재 등록 Team 계정 19개와 원천 계정을 대조해 원천 확인 계정 전체의 결재 등록과 7월 미활성 결재 계정 2개를 확인했습니다.",
  ],
};
