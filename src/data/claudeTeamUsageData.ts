...
const claudeTeamUsers: ClaudeTeamUserUsage[] = [
  ...
  },
  {
    ...
    models: [],
    level: "Low",
    note: "결재 등록 Standard 좌석 · Members/Spend/Code Lines 원천 미확인",
  },
];
...
export const initialClaudeTeamUsageData: ClaudeTeamUsageData = {
  source: {
    ...
    note: "Claude 멤버 목록(7월 20일), Spend report(7월 1-29일), Claude Code lines export(7월 1-31일)를 email 기준으로 결합하고 결재 등록 Team 계정 20개와 대조",
    verification: {
      spendRecords: 124,
      codeLineAccounts: 16,
      matchedAccounts: 16,
      ...
      note: "결재 등록 Team 계정은 20개이며 기존 멤버 CSV 19개 계정은 모두 Active입니다. 이동훈 부장 계정은 신규 할당되어 다음 원천 수집에서 활성 여부를 확인합니다.",
    },
  },
  licensedUsers: 20,
  activeUsers: 19,
  ...
  insights: [
    "결재 등록 Claude Team 좌석은 20개이며 7월 20일 멤버 CSV 기준 19명이 Active로 확인되어 현재 확인 활성률은 95%입니다.",
    ...
    "이동훈 부장은 Claude Team Standard 좌석이 새로 할당되었으며 다음 Members/Spend 원천 수집 전까지 사용 이력 확인 대기로 표시합니다.",
  ],
};
